      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
  className="w-full h-full absolute left-1/2 bottom-[-1px] will-change-transform transition-transform duration-[120ms] ease-out object-cover"
  src={avatarUrl}
  alt={`${name || 'User'} avatar`}
  loading="lazy"
  style={{
    transformOrigin: '50% 100%',
    /* 🟢 ADJUSTED SCALE BELOW: 
       Changed from 1 to 1.4 to "Zoom" in. 
       Adjust 1.4 higher or lower to fit your face perfectly. */
    transform:
      'translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scaleY(calc(1.4 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1.4 + (var(--pointer-from-left) - 0.5) * 0.01))',
    borderRadius: cardRadius,
    backfaceVisibility: 'hidden',
    minHeight: '100%', // Ensures it fills the card height
  }}
  onError={e => {
